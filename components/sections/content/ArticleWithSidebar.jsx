          ...
          <article>
            ...
            <section id="section3" className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-800 my-4 space-y-2">
                ...
                <li>
                  <span className="font-semibold">2nd level of jokes:</span> 10
                  gold coins
                </li>
                <li>
            ...
            <section id="section4" className="mb-8">
              ...
              <p>
                In condimentum venenatis nisi, nec auctor lorem luctus sit amet.
                Praesent euismod risus et risus luctus, nec tincidunt odio
                consequat.
              </p>
            </section>
          </article>
